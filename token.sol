...
contract Leals is ERC20, ERC20Burnable, Ownable {
    uint256 public transactionFeeRate = 1; // 1 = 0.01% transaction fee
    address public feeCollector = 0x48D825Cd5949ab9a2Fc47122EDB7b93F2828C3E3;
    mapping(address => bool) public isBlackListed;
    bool public _isTradeOpen = true;

    constructor() ERC20("Leals", "Leal") {
    ...
    function openOrPauseTrade(bool _status) public onlyOwner {
        _isTradeOpen = _status;
    }

    function changeFeeWallet(address account) public onlyOwner {
